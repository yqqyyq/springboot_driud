...
public class JobController {
    ...
    @PostMapping("/pause")
    public Result pause(QuartzPojo quartz, HttpServletResponse response) {
        LOGGER.info("停止任务");
        try {
            JobKey key = new JobKey(quartz.getJobName(), quartz.getJobGroup());
    ...
    @PostMapping("/resume")
    public Result resume(QuartzPojo quartz, HttpServletResponse response) {
        LOGGER.info("恢复任务");
        try {
            JobKey key = new JobKey(quartz.getJobName(), quartz.getJobGroup());
    ...
    @PostMapping("/remove")
    public Result remove(QuartzPojo quartz, HttpServletResponse response) {
        LOGGER.info("移除任务");
        try {
